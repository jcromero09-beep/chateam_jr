...
// ========================================
// [2026-08-01] Los parámetros de las colas (concurrencia, reintentos, limpieza,
// prioridades, rate limit, stall) son datos puros y viven en ./config/queueSettings.
// Aquí queda lo que hace algo: registrar jobs, montar workers y exponer las colas.
import {
  QUEUE_CONCURRENCY,
  QUEUE_RETRY_CONFIG,
  CLEANUP_CONFIG,
