...
import TermsProcessor from "../components/TermsProcessor";
...
import Receipt from "../pages/Recipts";
import TermsManagement from "../pages/TermsManagement";
// NUEVAS PÁGINAS - MÓDULO MARKETING
          ...
          <Switch>
            ...
            <WhatsAppsProvider>
              <AppLayout>
                ...
                <Route exact path="/recipts" component={Receipt} isPrivate />
                ...
                <Route exact path="/terms-management" component={TermsManagement} isPrivate />
                ...
                {/* NUEVAS RUTAS - MÓDULO MARKETING */}
                <Route exact path="/marketing/campaigns" component={MarketingCampaigns} isPrivate />
                <Route exact path="/marketing/insights" component={MarketingInsights} isPrivate />
                <Route exact path="/marketing/attribution" component={MarketingAttribution} isPrivate />
                <Route exact path="/marketing/audit" component={MarketingAudit} isPrivate />
                <Route exact path="/leads" component={Leads} isPrivate />
                <Route exact path="/billing" component={Billing} isPrivate />
