...
whatsappRoutes.get("/whatsapps", isAuth, WhatsAppController.index);
whatsappRoutes.get("/whatsapps/filter", isAuth, WhatsAppController.indexFilter);
whatsappRoutes.get("/whatsapps/all", isAuth, WhatsAppController.listAll);

whatsappRoutes.post("/whatsapp/", isAuth, WhatsAppController.store);
whatsappRoutes.post("/facebook/", isAuth, WhatsAppController.storeFacebook);
whatsappRoutes.post("/instagram/connect", isAuth, WhatsAppController.storeInstagram);
