...
contactRoutes.get("/contacts/import/status/:jobId", isAuth, ContactController.getImportStatus);
contactRoutes.post("/contacts/export/excel", isAuth, upload.array("file"), ContactController.exportToExcel);

contactRoutes.get("/contacts/export/download/:jobId", isAuth, ContactController.downloadExport);
