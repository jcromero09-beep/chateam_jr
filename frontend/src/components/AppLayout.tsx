      ...
      items: [
        {
          ...
          children: [
            ...
            {
              // Dashboard financiero global (solo super). Página existía sin ítem de menú.
              path: '/financial',
              label: 'Financiero',
              icon: <FinancialIcon />,
              roles: ['super'],
            ...
            {
              // Todas las conexiones de todas las empresas (solo super). Página existía sin menú.
        ...
        {
          // [Por Revisar] Páginas que existen pero no tenían acceso en el menú. Expuestas al super
          // para revisar qué hacen antes de decidir su ubicación/rol final. Sin `module` (el super
          // bypassa canAccess igual). Rutas confirmadas en App.tsx.
          path: '/review-group',
          label: 'Por Revisar',
          icon: <BuildIcon />,
          roles: ['super'],
          children: [
            { path: '/whatsapp/monitor', label: 'WhatsApp · Monitor', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/whatsapp/numbers', label: 'WhatsApp · Números', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/whatsapp/settings', label: 'WhatsApp · Ajustes', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/whatsapp/tester', label: 'WhatsApp · Tester', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/whatsapp/webhooks', label: 'WhatsApp · Webhooks', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/whatsapp/analytics', label: 'WhatsApp · Analytics', icon: <WhatsAppIcon />, roles: ['super'] },
            { path: '/openai/dashboard', label: 'OpenAI · Dashboard', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/openai/analytics', label: 'OpenAI · Analytics', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/openai/history', label: 'OpenAI · Historial', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/openai/models', label: 'OpenAI · Modelos', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/openai/templates', label: 'OpenAI · Plantillas', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/openai/testing', label: 'OpenAI · Testing', icon: <SmartToyIcon />, roles: ['super'] },
            { path: '/integrations-internal/dashboard', label: 'Integr. · Dashboard', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/billie', label: 'Integr. · Billie', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/sgr', label: 'Integr. · SGR', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/smarttrack', label: 'Integr. · SmartTrack', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/aria-lite', label: 'Integr. · Aria Lite', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/settings', label: 'Integr. · Ajustes', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/integrations-internal/webhooks', label: 'Integr. · Webhooks', icon: <IntegrationsIcon />, roles: ['super'] },
            { path: '/email-marketing/dashboard', label: 'Email Mkt · Dashboard', icon: <EmailIcon />, roles: ['super'] },
            { path: '/email-marketing/editor', label: 'Email Mkt · Editor', icon: <EmailIcon />, roles: ['super'] },
            { path: '/email-marketing/plantillas', label: 'Email Mkt · Plantillas', icon: <EmailIcon />, roles: ['super'] },
            { path: '/email-marketing/wizard', label: 'Email Mkt · Wizard', icon: <EmailIcon />, roles: ['super'] },
            { path: '/ugc', label: 'UGC · Hub', icon: <CampaignIcon />, roles: ['super'] },
            { path: '/ugc/analytics', label: 'UGC · Analytics', icon: <CampaignIcon />, roles: ['super'] },
            { path: '/ugc/creators', label: 'UGC · Creators', icon: <CampaignIcon />, roles: ['super'] },
            { path: '/ugc/social-accounts', label: 'UGC · Social Accounts', icon: <CampaignIcon />, roles: ['super'] },
            { path: '/agents/comments', label: 'Agentes · Comentarios', icon: <UsersIcon />, roles: ['super'] },
            { path: '/agents/devices', label: 'Agentes · Dispositivos', icon: <UsersIcon />, roles: ['super'] },
            { path: '/agents/identity', label: 'Agentes · Identidad', icon: <UsersIcon />, roles: ['super'] },
            { path: '/affiliates/tiers', label: 'Afiliados · Niveles', icon: <UsersIcon />, roles: ['super'] },
            { path: '/affiliates/withdrawals', label: 'Afiliados · Retiros', icon: <UsersIcon />, roles: ['super'] },
          ],
        },
      ],
    },
