// [Fase2·G · Tickets F3] Dropdown menu accesible (Radix) con tokens del design system.
  ...
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        ...
        // Animación shadcn: fade + zoom + slide direccional según el lado en que abre.
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex size-4 items-center justify-center">
      <DropdownMenuPrimitive.ItemIndicator><Check className="size-4" aria-hidden /></DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
));
